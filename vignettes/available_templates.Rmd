...
**Please note that, for space issues, the charts will be particularly small, so the text may appear too large or not perfectly positioned. However, when the functions are used normally, everything will be proportioned and well placed.**
